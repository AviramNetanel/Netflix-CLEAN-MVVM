//
//  DefaultDisplayViewViewModel.swift
//  netflix
//
...
// MARK: - DisplayViewViewModelInput protocol

private protocol DisplayViewViewModelInput {
    func path(with media: Media) -> String?
    func genres(for media: Media) -> NSMutableAttributedString
}

// MARK: - DisplayViewViewModelOutput protocol

private protocol DisplayViewViewModelOutput {
    var slug: String { get }
...
// MARK: - DisplayViewViewModel protocol

private protocol DisplayViewViewModel: DisplayViewViewModelInput,
                                       DisplayViewViewModelOutput {}

// MARK: - DefaultDisplayViewViewModel struct
